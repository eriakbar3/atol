  ...
  <body>
      ...
      <div class="container">
        <div class="produk">
          <div class="row">
            <div class="title">
              <div class="bag-kiri">
                <h2 class="title-content">Barang Baru</h2>
              </div>
              <div class="bag-kanan">
            ...
            <?php foreach ($paket as $pakets): ?>
              <div class="col-sm-12">
                <div class="col-sm-3">
                  <div class="thumbnail">
                    <a href="#">
                      <img class="myimg" src="image/<?php echo $pakets->gambar?>" alt="Lights" style="width:100%">
                      <div class="caption">
    ...
    <div class="footer">
      <div class="container">
        ...
        <div class="col-sm-4">
          <img src="assets/img/unikom.png" alt="" class="img-responsive" style="height:150px;margin-left:125px">
